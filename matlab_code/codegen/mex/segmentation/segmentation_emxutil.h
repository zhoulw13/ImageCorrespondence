/*
 * segmentation_emxutil.h
 *
 * Code generation for function 'segmentation_emxutil'
 *
 * C source code generated on: Sun Apr 24 19:21:27 2016
 *
 */

#ifndef __SEGMENTATION_EMXUTIL_H__
#define __SEGMENTATION_EMXUTIL_H__
/* Include files */
#include <math.h>
#include <stdlib.h>
#include <string.h>
...
extern void b_emxCopyStruct_struct_T(const emlrtStack *sp, b_struct_T *dst, const b_struct_T *src, const emlrtRTEInfo *srcLocation);
...
extern void b_emxInitStruct_struct_T(const emlrtStack *sp, b_struct_T *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush);
...
extern void emxCopyStruct_struct_T(const emlrtStack *sp, struct_T *dst, const struct_T *src, const emlrtRTEInfo *srcLocation);
...
extern void emxInitStruct_struct_T(const emlrtStack *sp, struct_T *pStruct, const emlrtRTEInfo *srcLocation, boolean_T doPush);
...
#endif
/* End of code generation (segmentation_emxutil.h) */
