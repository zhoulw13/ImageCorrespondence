...
#ifndef __MERGING_MEXUTIL_H__
#define __MERGING_MEXUTIL_H__
/* Include files */
#include <math.h>
#include <stdlib.h>
#include <string.h>
...
extern const mxArray *message(const emlrtStack *sp, const mxArray *b, emlrtMCInfo *location);
#endif
/* End of code generation (merging_mexutil.h) */
