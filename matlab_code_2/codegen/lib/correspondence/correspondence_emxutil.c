...
static void b_emxExpand_struct_T(emxArray_b_struct_T *emxArray, int fromIndex,
  int toIndex);
static void b_emxTrim_struct_T(emxArray_b_struct_T *emxArray, int fromIndex, int
  toIndex);
...
void b_emxEnsureCapacity_struct_T(emxArray_b_struct_T *emxArray, int oldNumel)
{
  int elementSize;
  int newNumel;
  int i;
...
/* End of code generation (correspondence_emxutil.c) */
