...
void b_emxCopyStruct_struct_T(const emlrtStack *sp, struct_T *dst, const
  struct_T *src, const emlrtRTEInfo *srcLocation)
{
...
void b_emxFreeStruct_struct_T(struct_T *pStruct)
{
...
void b_emxInitStruct_struct_T(const emlrtStack *sp, struct_T *pStruct, const
...
/* End of code generation (merging_emxutil.c) */
