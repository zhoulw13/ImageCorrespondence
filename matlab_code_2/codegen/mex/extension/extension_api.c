...
static emlrtRTEInfo hc_emlrtRTEI = { 1, 1, "extension_api", "" };
  ...
  emlrtMsgIdentifier *parentId, emxArray_struct_T *y)
{
  ...
  emlrtCheckVsStructR2012b(sp, parentId, u, 1, fieldNames, 2U, iv88, bv0, sizes);
  ...
  emxArray_struct_T *u)
{
  ...
  emlrtAssign(&y, mxCreateStructArray(2, iv91, 0, NULL));
  i = 0;
  b_j1 = 0;
  ...
  emxArray_b_struct_T *u)
{
  ...
  emlrtAssign(&y, mxCreateStructArray(2, iv92, 0, NULL));
  i = 0;
  b_j1 = 0;
  emxInit_real_T(sp, &b_u, 2, (emlrtRTEInfo *)NULL, TRUE);
  ...
  emlrtMsgIdentifier *parentId, emxArray_b_struct_T *y)
{
  ...
  emlrtCheckVsStructR2012b(sp, parentId, u, 2, fieldNames, 2U, iv89, bv2, sizes);
...
{
  const mxArray *y;
  static const int32_T iv93[3] = { 0, 0, 0 };

  const mxArray *m13;
  y = NULL;
  m13 = mxCreateNumericArray(3, (int32_T *)&iv93, mxDOUBLE_CLASS, mxREAL);
...
{
  const mxArray *y;
  static const int32_T iv90[1] = { 0 };

  const mxArray *m11;
  y = NULL;
  m11 = mxCreateNumericArray(1, (int32_T *)&iv90, mxDOUBLE_CLASS, mxREAL);
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", FALSE, 2U, iv94, bv4, iv95);
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", FALSE, 2U, iv96, bv5, iv97);
  ret->size[0] = iv97[0];
  ret->size[1] = iv97[1];
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  boolean_T bv6[3];
  int32_T i;
  static const int8_T iv99[3] = { -1, -1, 3 };
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", FALSE, 3U, iv98, bv6,
    iv100);
  ret->size[0] = iv100[0];
  ret->size[1] = iv100[1];
  ret->size[2] = iv100[2];
                   ...
                   plhs[5])
{
  ...
  c_emxInit_real_T(sp, &Src_lab, 3, &hc_emlrtRTEI, TRUE);
  c_emxInit_real_T(sp, &Ref_lab, 3, &hc_emlrtRTEI, TRUE);
  b_emxInit_real_T(sp, &errors, 1, &hc_emlrtRTEI, TRUE);
  emxInit_struct_T(sp, &ref_set, 2, &hc_emlrtRTEI, TRUE);
  c_emxInit_real_T(sp, &Corr, 3, &hc_emlrtRTEI, TRUE);
  ...
  extension(sp, sp_set, bspline_set, Sp2, Src_lab, Ref_lab, errors, ref_set,
            Corr);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(errors);
  plhs[1] = b_emlrt_marshallOut(sp, sp_set);
  plhs[2] = b_emlrt_marshallOut(sp, ref_set);
  plhs[3] = d_emlrt_marshallOut(sp, bspline_set);
  plhs[4] = e_emlrt_marshallOut(Corr);
